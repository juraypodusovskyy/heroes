...
import { fetchHero,selectAll,heroDeleted } from '../../reducers/heroReducer';
    ...
    const selector = createSelector(
        ...
        (heroes,filter) => {
            if(filter === 'all'){
                ...
                return heroes.filter(value => value.element === filter)
            }
        }
    );

    const filteredHeroes = useSelector(selector);
